...
The .ino file is the original Arduino Sketch and the other file is the Proteus project file. 

To be able to use the Arduino sketch, I already mentioned the pin connections in the Arduino sketch, make the connections accordingly and use the sketch.
